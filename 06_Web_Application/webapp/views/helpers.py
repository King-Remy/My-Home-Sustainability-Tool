...
class helper:
    ...
    window_description = {'Double glazed from 2020': 1.60, 'Double glazed': 2.10,
                          'Single glazed': 4.80, 'I dont know the window type': 4.80}
    ...
    def calculateTotalExternalWallArea(self, formData, windowObject, doorObject):
        ...
        masonaryArea = (buildingWidth * heightofWall) * noofExternalWalls

        totalExternalWallArea = masonaryArea - self.windowSizeAreas - self.doorSizeAreas 
    ...
    def calculateFloorHeatLoss(self, formData):
        ...
        floorType = float(formData['extension3Width'])
        ...
        floorResitance = helper.floor_description[formData['floorType']]
